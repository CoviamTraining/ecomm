...
public interface ProductRepository extends CrudRepository<Product,Integer>{
    ...
    @Query("select new com.coviam.ecomm.dto.ProductInfoForList(p.productid, p.name,p.imageurl,p.rating) from Product p where p.productid = :id")
    ...
    @Query("select new com.coviam.ecomm.dto.ProductInfoForList(p.productid, p.name,p.imageurl,p.rating) " +
